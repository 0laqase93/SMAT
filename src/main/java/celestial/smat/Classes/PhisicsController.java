...
public class PhisicsController {
    private final boolean PHISICSON = true;
    ...
    static final Double SCALE = 191 / UA; // 1UA = 100 píxeles en la pantalla
    static final Double RADIUSSCALE = 0.4e-3;
    static final Double TIMESTEP = 3600.0 * 7.6;
